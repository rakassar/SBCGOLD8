...
*/
   ...
   public class SC_009_Case_AccountBalanceComputation extends HomePageMethod
   {
    ...
    @Test(priority=1)
	public void SC_009_TC_001() throws Exception
	{
    ...
    @Test(priority=2)
    public void SC_009_TC_002() throws Exception
    {
    	Thread.sleep(1500);
	    launchBrowser();
	    //TDFX.DataRead();
