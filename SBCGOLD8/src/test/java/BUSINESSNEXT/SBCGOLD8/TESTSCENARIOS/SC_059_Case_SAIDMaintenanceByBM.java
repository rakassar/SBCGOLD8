...
*/
   ...
   public class SC_059_Case_SAIDMaintenanceByBM extends HomePageMethod
   {
    ...
    @Test(priority=1)
	public void SC_059_TC_001() throws Exception
	{
    	launchBrowser();
    	...
    	Thread.sleep(5000);
 		...
 		Thread.sleep(1000);
        screen.ScreenshotMethod("SC_059_Case_SAIDMaintenanceByBM-");
