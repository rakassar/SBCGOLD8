...
*/
   ...
   public class SC_058_Case_BankInitiatedInfoMaintenancebyCC extends HomePageMethod
   {
    ...
    @Test(priority=1)
	public void SC_058_TC_001() throws Exception
	{
    	...
    	Thread.sleep(5000);
 		...
 		Thread.sleep(1000);
        screen.ScreenshotMethod("SC_058_Case_BankInitiatedInfoMaintenancebyCC");
